...
def main(args):
    ...
    data_loader = FeatureLoader(params, args.decode_set, is _eval=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m','--load_model', type=str, default="/home/yuanhui/OpenTransformer/save_models/11-26-09-00-19/model.epoch.79.pt")
